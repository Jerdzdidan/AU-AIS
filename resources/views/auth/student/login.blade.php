            ...
            <div class="card-body">
              <!-- Logo -->
                <div class="app-brand justify-content-center">
                    ...
                    <span class="app-brand-text demo text-heading fw-bold ms-3">AU-AIS (STUDENT)</span>
                </div>
              <!-- /Logo -->
                ...
                <form id="formAuthentication" method="post" action="{{ route('auth.student.authenticate') }}" class="mb-6">
                    @csrf
                    <div class="mb-6">
                        <label for="student_number">Student Number:</label>
                        <input type="text" name="student_number" id="student_number" class="form-control" placeholder="Enter your student number" autofocus maxlength="150" required>
                    </div>
