            ...
            <div class="card-body">
              <!-- Logo -->
                <div class="app-brand justify-content-center">
                    ...
                    <span class="app-brand-text demo text-heading fw-bold ms-3">AU-AIS</span>
                </div>
              <!-- /Logo -->
                ...
                <div class="d-flex align-items-center gap-2 mb-4">
                    ...
                    <p class="mb-0">Please select your destination:</p>
                </div>
                <div class="row g-3">
                    <div class="col-12">
                        <a href="{{ route('auth.student.login') }}" class="btn btn-primary py-3 w-100 fs-5" style="border-radius: 5px">STUDENT</a>
                    </div>
                    <div class="col-12">
                        <a href="{{ route('auth.admin.login') }}" class="btn btn-danger py-3 w-100 fs-5" style="border-radius: 5px">ADMIN</a>
                    </div>
                </div>
