...
<x-sidebar.item route='student.manual.index' name='Manual' icon='fa-solid fa-book me-2'/>

<li class="menu-header small text-uppercase">
    <span class="menu-header-text">General Information</span>
</li>

<x-sidebar.item route='student.faqs.index' name='FAQs' icon='fa-solid fa-question-circle me-2' />

<x-sidebar.item route='student.help.index' name='Help' icon='fa-solid fa-question-circle me-2' />
