...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <a href="{% url "core:home" %}" class="app-brand-link">
        <span class="app-brand-logo demo">
            <img src="{% static 'img/logo/arellano_logo.png' %}" alt="">
        </span>
        <span class="app-brand-text demo menu-text fw-bold ms-4">AU-DRS</span>
    </a>
    </div>
    ...
    <!-- Home -->
    <li class="menu-item {% if 'core:home' in request.resolver_match.view_name %}active{% endif %}">
        <a href="{% url 'core:home' %}" class="menu-link">
    ...
    <li class="menu-item">
        <a href="#" class="menu-link">
            ...
            <div class="text-truncate" data-i18n="Home">Dashboard</div>
        </a>
    </li>
    <!-- Dashboards -->
    <li class="menu-item">
